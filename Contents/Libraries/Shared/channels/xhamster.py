...
def videos(item):
    ...
    if len(anterior)>0:
        itemlist.append( Item(channel=__channel__, action='videos' , title="<< Pagina anterior" , url=urlparse.urljoin( "http://www.xhamster.com" , anterior[0] ), thumbnail="", plot="", show="!Página anterior") )
    else:
        paginador = None
